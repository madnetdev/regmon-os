...
if (count($rows)) {
	...
	foreach ($rows as $row) {
		...
		$link_view = ' class="group_user_status" href="javascript:void(0)" data-toggle="popover" data-placement="bottom" data-html="true" title="'
			.'Profil'.': <b>'.$profil.'</b><br>'
			.'" data-content="'
				.$LANG->STATUS.': <b>'.$req_text[$status1].'</b><br><span class=popover_nowrap><hr>'
