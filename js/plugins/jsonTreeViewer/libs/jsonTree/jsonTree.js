    ...
    var utils = {
        ...
        forEachNode : function(obj, func) {
            ...
            switch (type) {
                ...
                case 'object':
                    var keys = Object.keys(obj);//.sort();  //@@@@@@@MAD
                    ...
                    str = '\
                        <div class="jsontree_value-wrapper">\
                            <div class="jsontree_value jsontree_value_' + self.type + '">\
                                <b>' + sym[0] + '</b>\
                                <span class="jsontree_show-more">('+Object.keys(val).length+')</span>\
    ...
    utils.extend(_NodeComplex.prototype, {
        ...
        toggle : function(isRecursive) {
			...
			setTimeout(function(){ //for loading
				...
				if (isRecursive) {
					var isExpanded = this_el.classList.contains('jsontree_node_expanded');
