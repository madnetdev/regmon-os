...
function get_Extra_DashboardSample_Init_SQL(string $datetime):string {
	return "".
		...
		"(4, 6, 1, 'Trainingload (RPE>5)', 'forms_results', '6__2__1__10__week', 4, '#cccccc', '".$datetime."', 'Auto_Init','".$datetime."', 'Auto_Init'),".
...
function get_Extra_AxisSample_Init_SQL(string $datetime):string {
	return "".
		...
		"(2, 1, 1, 1, 'KEB-Achse (links)', '{\"axis\":{\"id\":\"\",\"name\":\"KEB (0 [trifft gar nicht zu] bis 6 [trifft voll zu])\",\"color\":\"\",\"min\":\"0\",\"max\":\"6\",\"pos\":\"false\",\"grid\":\"0\"}}', '".$datetime."', 'Auto_Init','".$datetime."', 'Auto_Init'),".
		"(3, 1, 1, 1, 'KEB-Achse (rechts)', '{\"axis\":{\"id\":\"\",\"name\":\"KEB (0 [trifft gar nicht zu] bis 6 [trifft voll zu])\",\"color\":\"\",\"min\":\"0\",\"max\":\"6\",\"pos\":\"true\",\"grid\":\"0\"}}', '".$datetime."', 'Auto_Init','".$datetime."', 'Auto_Init');";
}
