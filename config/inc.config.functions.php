...
function get_Extra_NotesSampleData_Init_SQL(string $datetime):string {
	...
	// create string array with the date of variable $datetimeStart shifted by 159 days + DaysOffSet, complemented by timesStart
	...
	// create string array with the date of variable $datetimeStart shifted by 159 days + DaysOffSet, complemented by timesEnd
